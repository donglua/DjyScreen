...
import xyz.djy0.djyscreen.renderscript.YuvConverter;
import xyz.djy0.djyscreen.util.L;

/**
 * @author wuwen E-mail: wuwen@tigerbrokers.com
 * @version 创建时间: 2016/10/15 下午12:55
 */
  ...
  private void feedMe() throws Exception {
    ...
    while (true) {
      ...
      if (dequeueInputBuffer >= 0) {
        ...
        L.d("Feeder", "Bitmap info " + scaledBitmap.getWidth() + " " + scaledBitmap.getHeight() + " " +
