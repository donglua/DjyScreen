...
public class zzhm
{
    ...
    public void zza(final int n, final int n2, final int n3, final int n4, final float n5, final int n6) {
        try {
            this.zzbkr.zzb("onScreenInfoChanged", new JSONObject().put("width", n).put("height", n2).put("maxSizeWidth", n3).put("maxSizeHeight", n4).put("density", (double)n5).put("rotation", n6));
        }
    ...
    public void zzb(final int n, final int n2, final int n3, final int n4) {
        try {
            this.zzbkr.zzb("onSizeChanged", new JSONObject().put("x", n).put("y", n2).put("width", n3).put("height", n4));
        }
        catch (JSONException ex) {
    ...
    public void zzc(final int n, final int n2, final int n3, final int n4) {
        try {
            this.zzbkr.zzb("onDefaultPositionReceived", new JSONObject().put("x", n).put("y", n2).put("width", n3).put("height", n4));
        }
        catch (JSONException ex) {
