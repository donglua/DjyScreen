    ...
    protected void onMeasure(final int n, final int n2) {
        ...
        if (this.zzapc.zzaxm) {
            ...
            // monitorexit(o)
                ...
                this.zzdk("(function() {  var height = -1;  if (document.body) { height = document.body.offsetHeight;}  else if (document.documentElement) {      height = document.documentElement.offsetHeight;  }  var url = 'gmsg://mobileads.google.com/contentHeight?';  url += 'height=' + height;  window.googleAdsJsInterface.notify(url);  })();");
                ...
                if (map != null) {
                    ...
                    if (!TextUtils.isEmpty((CharSequence)s)) {
                        try {
                            ...
                            zzb.zzd("Exception occurred while getting webview content height", ex);
                        }
                    }
                }
            }
