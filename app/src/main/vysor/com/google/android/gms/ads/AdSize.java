...
public final class AdSize
{
    ...
    AdSize(final int zzajw, final int zzajx, final String zzajy) {
        if (zzajw < 0 && zzajw != -1 && zzajw != -3) {
            throw new IllegalArgumentException(new StringBuilder(37).append("Invalid width for AdSize: ").append(zzajw).toString());
        }
        if (zzajx < 0 && zzajx != -2 && zzajx != -4) {
            throw new IllegalArgumentException(new StringBuilder(38).append("Invalid height for AdSize: ").append(zzajx).toString());
        }
        this.zzajw = zzajw;
        this.zzajx = zzajx;
        this.zzajy = zzajy;
