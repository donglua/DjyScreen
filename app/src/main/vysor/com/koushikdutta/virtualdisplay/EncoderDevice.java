...
public abstract class EncoderDevice
{
    ...
    public Surface createDisplaySurface() {
        ...
        //    12: aload_0        
        //    13: aconst_null    
        //    14: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.venc:Landroid/media/MediaCodec;
        //    17: aconst_null    
        //    18: astore_1       
        ...
        //   444: istore          36
        //   446: aload_0        
        //   447: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //   450: aload_0        
        //   451: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //   454: if_icmple       1080
        //   457: aload_0        
        //   458: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //   461: iload           35
        //   463: if_icmple       496
        //   466: iload           35
        //   468: i2d            
        //   469: aload_0        
        //   470: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //   473: i2d            
        //   474: ddiv           
        //   475: dstore          43
        //   477: aload_0        
        //   478: iload           35
        //   480: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //   483: aload_0        
        //   484: dload           43
        //   486: aload_0        
        //   487: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //   490: i2d            
        //   491: dmul           
        //   492: d2i            
        //   493: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //   496: aload_0        
        //   497: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //   500: iload           36
        //   502: if_icmple       535
        //   505: iload           36
        //   507: i2d            
        //   508: aload_0        
        //   509: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //   512: i2d            
        //   513: ddiv           
        //   514: dstore          41
        //   516: aload_0        
        //   517: iload           36
        //   519: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //   522: aload_0        
        //   523: dload           41
        //   525: aload_0        
        //   526: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //   529: i2d            
        //   530: dmul           
        //   531: d2i            
        //   532: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //   535: aload_0        
        //   536: aload_0        
        //   537: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //   540: bipush          16
        //   542: idiv           
        //   543: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //   546: aload_0        
        //   547: bipush          16
        //   549: aload_0        
        //   550: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //   553: imul           
        //   554: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //   557: aload_0        
        //   558: aload_0        
        //   559: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //   562: bipush          16
        //   564: idiv           
        //   565: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //   568: aload_0        
        //   569: bipush          16
        //   571: aload_0        
        //   572: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //   575: imul           
        //   576: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //   579: aload_0        
        ...
        //   595: aload_0        
        //   596: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        ...
        //   607: aload_0        
        //   608: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        ...
        //   625: dup            
        //   626: aload_0        
        //   627: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //   630: aload_0        
        //   631: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        ...
        //   640: ldc             "video/avc"
        //   642: aload_0        
        //   643: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //   646: aload_0        
        //   647: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        ...
        //   802: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.venc:Landroid/media/MediaCodec;
        //   805: aload_0        
        ...
        //   826: pop            
        //   827: aload_0        
        //   828: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.venc:Landroid/media/MediaCodec;
        //   831: aload           13
        //   833: aconst_null    
        //   834: aconst_null    
        //   835: iconst_1       
        ...
        //   876: ifeq            888
        //   879: aload_0        
        //   880: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.venc:Landroid/media/MediaCodec;
        ...
        //   898: pop            
        //   899: aload_0        
        //   900: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.venc:Landroid/media/MediaCodec;
        ...
        //   917: aload_0        
        //   918: aload_0        
        //   919: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.venc:Landroid/media/MediaCodec;
        ...
        //  1077: goto            421
        //  1080: aload_0        
        //  1081: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //  1084: iload           35
        //  1086: if_icmple       1119
        //  1089: iload           35
        //  1091: i2d            
        //  1092: aload_0        
        //  1093: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //  1096: i2d            
        //  1097: ddiv           
        //  1098: dstore          39
        //  1100: aload_0        
        //  1101: iload           35
        //  1103: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //  1106: aload_0        
        //  1107: dload           39
        //  1109: aload_0        
        //  1110: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //  1113: i2d            
        //  1114: dmul           
        //  1115: d2i            
        //  1116: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //  1119: aload_0        
        //  1120: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //  1123: iload           36
        //  1125: if_icmple       535
        //  1128: iload           36
        //  1130: i2d            
        //  1131: aload_0        
        //  1132: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //  1135: i2d            
        //  1136: ddiv           
        //  1137: dstore          37
        //  1139: aload_0        
        //  1140: iload           36
        //  1142: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.width:I
        //  1145: aload_0        
        //  1146: dload           37
        //  1148: aload_0        
        //  1149: getfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //  1152: i2d            
        //  1153: dmul           
        //  1154: d2i            
        //  1155: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.height:I
        //  1158: goto            535
        //  1161: aload_0        
        //  1162: aload_1        
        //  1163: ldc             "video/avc"
        ...
        //  1195: ldc_w           "Exception creating venc"
        //  1198: aload           18
        ...
        //  1241: putfield        com/koushikdutta/virtualdisplay/EncoderDevice.venc:Landroid/media/MediaCodec;
        //  1244: goto            805
        //  1247: iinc            57, 1
        //  1250: goto            27
        //    Exceptions:
